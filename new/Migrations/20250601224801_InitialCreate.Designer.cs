...
namespace ConferenceManager.Migrations
{
    ...
    [Migration("20250601224801_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ConferenceManager.Models.ConferenceSponsor", b =>
                {
                    b.Property<int>("ConferenceId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ConferenceId", "SponsorId");
            ...
            modelBuilder.Entity("ConferenceManager.Models.PresentationSpeaker", b =>
                {
            ...
            modelBuilder.Entity("ConferenceManager.Models.ConferenceSponsor", b =>
                {
                    ...
                    b.HasOne("ConferenceManager.Models.Sponsor", "Sponsor")
            ...
            modelBuilder.Entity("ConferenceManager.Models.PresentationSpeaker", b =>
                {
                    ...
                    b.HasOne("ConferenceManager.Models.User", "User")
                        .WithMany("PresentationSpeakings")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ConferenceManager.Models.Sponsor", b =>
                {
                    b.Navigation("ConferenceSponsors");
                });
            ...
            modelBuilder.Entity("ConferenceManager.Models.User", b =>
                {
                    ...
                    b.Navigation("PresentationSpeakings");
